...
const kinveyAppKey = "kid_rkMz6luMg";
const kinveyAppSecret = "93120d713a5c4ec3a0beb7d89da88762";
...
function editAd () {
    ...
    let updateAddRequest = {
        method: 'PUT',
        url: `${kinveyBaseUrl}/appdata/${kinveyAppKey}/posters/${adId}`,
        headers: {
...
function createAd () {
    ...
    let createAdRequest = {
        method: 'POST',
        url: `${kinveyBaseUrl}/appdata/${kinveyAppKey}/posters`,
        headers: {
            'Authorization': `Kinvey ${sessionStorage.getItem('authToken')}`,
            'Content-Type': 'application/json'
        },
